  ...
  goGushou.init = function(){
    goGushou.stickyLogo();
    goGushou.formSwitch();
    goGushou.pwCheck();
  };//gushou init

  goGushou.formSwitch = function(){
